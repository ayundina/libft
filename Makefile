...
#    Updated: 2019/02/18 14:35:55 by ayundina      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	   ...
	   ft_lstadd.c ft_lstiter.c ft_lstmap.c ft_intlen.c ft_getnum.c \
	   ft_dupword.c ft_getwords.c ft_countwords.c ft_beg_sp.c ft_end_sp.c
